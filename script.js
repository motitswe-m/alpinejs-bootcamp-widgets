...
const calculateAirtime = () => {
  ...
  const availableAirtime = parseFloat(
    document.getElementById("availableAirtime").value
  );
  ...
  document.getElementById("remainingAirtimeDisplay").textContent =
    remainingAirtime;
};
